      ...
      <div className="container">
        <div className="mx-auto w-full max-w-lg text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "Levela's ability to keep our building operational whilst stripping
            twelve floors was exceptional. They understood the complexity and
            delivered without compromise on safety or schedule."
          </blockquote>
          <div className="mt-6 flex w-full flex-col items-center justify-center gap-3 text-center md:mt-8 md:w-auto md:flex-row md:gap-5 md:text-left">
            ...
            <div className="mb-4 md:mb-0">
              <p>James Mitchell</p>
              <p>Project Manager, Cornerstone Developments</p>
            </div>
          </div>
        </div>
      </div>
